...
class ExampleConfiguration : Configuration() {
    ...
    companion object {
        ...
        init {
            _encrypted_string_Textfield_ListValues["Red"] = if (BuildConfig.ENCRYPTED) "3/iZZ1Gv8EniGIkIoUzLdJI8SN8tGjus/jGanA6kRM+afnCJYI4E/6Nc1CWK7eIAJBuZRceU6rtlY/OPTSubV4kLQkf/I4gN4pdrC0" +
            ...
            _encrypted_string_Textfield_ListValues["Green"] = if (BuildConfig.ENCRYPTED) "PkQfHwaWmK94u9eB9mCfWmOk/vOIOacKivt1lptgJbUzUl2e8pmRnSVLkCeYxoSjPgKEx94t6e/BRhtgMbZyXoo2usUH5jdxaA8Hko" +
            ...
            _encrypted_string_Textfield_ListValues["Blue"] = if (BuildConfig.ENCRYPTED) "jaIxDwexYEFUlmoG8QsdKYbj/g2zZWL0q5gmeWGCuLOwXvUHdB0CU7i4v/55LEi3UuN7L9Yj4zjWX//WZB0HFn5+9NZ8IG9xoc+uE+" +
        ...
        init {
            _encrypted_string_RegexTextfield_ListValues["Dev"] = if (BuildConfig.ENCRYPTED) "jm9SM4MEYa4FRbTrK23n6QWpBl0MfLolPPUrnaUcMcCzmJbzBT0MumGIEFFthMFbx5ZZta8mCIKYwBR2Cu/2b52rFUr2N8xCuWiWUR" +
            ...
            _encrypted_string_RegexTextfield_ListValues["Test"] = if (BuildConfig.ENCRYPTED) "4H4M2YQ2XH+bm7FYVm1sQuN+DaUQdvJecWLKYo3peUYwNJsw+bE/ANFbtfD6xDWCnDW8Bs62tqYDtyg6YhucnTjx82c+axxKG/eDpE" +
            ...
            _encrypted_string_RegexTextfield_ListValues["Prod"] = if (BuildConfig.ENCRYPTED) "IE7X1bkOQGAqCTtLk011hG0Kmj5l0RkSviSO6IfItnIlSEL66ZH1cO4vmN8FtjkWhD+zvcDzHkcsVSsqPrkmYJl29I2otn2dXa9tNI" +
